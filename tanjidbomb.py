...
\033[1;32m[-] TOOLS TYPE:\033[1;32m TRAIL
\033[1;32m[-] AUTHOR    :\033[1;32m TANJID TECHNOLOGY
\033[1;32m[-] GITHUB    :\033[1;32m TOXIQARCHOWDHURYTS
\033[1;32m[-] FACEBOOK  :\033[1;32m TANJID AHMED
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH TANJID TECHNOLOGY ;) {w}<{r}/{w}>\n\n")
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥TANJID TECHNOLOGY🔥 "+w+tim)
